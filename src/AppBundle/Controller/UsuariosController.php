...
class UsuariosController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            $em = $this->getDoctrine()->getManager();
            $entity->setPassword($this->generarPassword($entity));
            $em->persist($entity);
            $em->flush();
        ...
        return $this->render('::/Admin/Usuarios/new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        return $this->render('::/Admin/Usuarios/show.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    protected function generarPassword($entidad) {
