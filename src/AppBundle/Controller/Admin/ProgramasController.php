...
use AppBundle\Form\ProgramasType;
...
class ProgramasController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppBundle:Programas')->findAll();

        return $this->render('AppBundle:Programas:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_programas_show', array('id' => $entity->getId())));
        }

        return $this->render('AppBundle:Programas:new.html.twig', array(
            'entity' => $entity,
    ...
    private function createCreateForm(Programas $entity)
    {
        $form = $this->createForm(new ProgramasType(), $entity, array(
            'action' => $this->generateUrl('admin_programas_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        return $this->render('AppBundle:Programas:show.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    {
        $form = $this->createForm(new ProgramasType(), $entity, array(
            'action' => $this->generateUrl('admin_programas_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_programas_edit', array('id' => $id)));
        }
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('admin_programas'));
    }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_programas_delete', array('id' => $id)))
            ->setMethod('DELETE')
